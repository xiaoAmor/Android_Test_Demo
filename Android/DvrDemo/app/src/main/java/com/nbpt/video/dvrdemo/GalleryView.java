...
public class GalleryView extends ViewPager {
	...
	public GalleryView(Context context, AttributeSet attrs) {
		...
		int effect = ta.getInt(R.styleable.GalleryView_style, 0);
		...
		setFadeEnabled(ta
				.getBoolean(R.styleable.GalleryView_fadeEnabled, false));
		setOutlineEnabled(ta.getBoolean(R.styleable.GalleryView_outlineEnabled,
				false));
		setOutlineColor(ta.getColor(R.styleable.GalleryView_outlineColor,
				Color.WHITE));
		switch (mEffect) {
		case Stack:
		case ZoomOut:
