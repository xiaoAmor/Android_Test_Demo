...
//	}
    ...
    public void handleMessage(final Message msg) {
        ...
        switch (msg.what) {
            case MSG_OPEN:
                Log.d(TAG, "handleMessage: 打开摄像头");
                thread.handleOpen((USBMonitor.UsbControlBlock) msg.obj);
                break;
            case MSG_CLOSE:
                Log.d(TAG, "handleMessage: 关闭摄像头");
                thread.handleClose();
                break;
            case MSG_PREVIEW_START:
                Log.d(TAG, "handleMessage: 开始预览消息");
...
//		}
        ...
        public void handleOpen(final USBMonitor.UsbControlBlock ctrlBlock) {
            ...
            if (DEBUG)
                Log.i(TAG, "摄像头支持的视频分辨率supportedSize:" + (mUVCCamera != null ? mUVCCamera.getSupportedSize() : null));
        }
        ...
        public void handleStartPreview(final Object surface) {
            if (DEBUG) Log.v(TAG_THREAD, "handleStartPreview:1");
...
//			}
            ...
            // 返回路径
            if (mListener != null) {
                Log.d(TAG, "handleStopPusher: 文件名:"+videoPath);
...
//				}
        ...
        public void handleCameraFoucs() {
            if (DEBUG) Log.v(TAG_THREAD, "handleStartPreview:2");
